...
他の手法のインストールおよび機能の詳細については 4. システムの詳細 をご覧ください．
...
<img src="src/quick_start_ 04.png">
...
<img src="src/quick_start_ 05.png">

学習が完了あるいは中断されると実行結果や3次元再構築結果等が表示されます． 
失敗した場合は`📝実行ログ`を確認してください． 

<img src="src/quick_start_ 06.png">
<img src="src/quick_start_ 07.png">

## 3.6. Mip-Splatting の評価
`🚀レンダリング＆評価実行`ボタンを押すことで3次元再構築結果からテスト画像のレンダリングと，テスト画像の定量的評価を行うことができます．  

<img src="src/quick_start_ 08.png">
<img src="src/quick_start_ 09.png">
