...
学習の中断は行えまぜん．学習前に`🗂️ 現在セットされているCOLMAPデータセット`が正しいものか確認してください．  
...
## 3.6. 3次元再構築結果の可視化
このシステムでは **viser** を使って3次元再構築結果を可視化しています．`🚀 ビューアの起動`ボタンを押すことでサーバを立ち上げることができます．  
`ビューアのURL`にURLが表示されれば立ち上げ成功です．ブラウザからアクセスしてください．
