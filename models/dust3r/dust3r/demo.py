...
def get_args_parser():
    ...
    parser.add_argument("--server_port", type=int, default=None,
                        help="Start gradio app on this port. If None, will search from 7860.")
    parser_weights = parser.add_mutually_exclusive_group(required=True)
    parser_weights.add_argument("--weights", type=str, default=None, help="Path to model weights")
